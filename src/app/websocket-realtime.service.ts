...
export class WebsocketRealtimeService {
  ...
  public onMessageReceived(message) { 
    ...
    (<HTMLSelectElement>document.getElementById("first_one_animal")).innerHTML=this.message_result[0];
    (<HTMLSelectElement>document.getElementById("first_one_time")).innerHTML=this.time_result[0];
    if(this.message_result.length!=1){
    (<HTMLSelectElement>document.getElementById("second_one_animal")).innerHTML=this.message_result[1];
    (<HTMLSelectElement>document.getElementById("second_one_time")).innerHTML=this.time_result[1];   
    }
